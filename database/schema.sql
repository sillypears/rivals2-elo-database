...
--
-- Host: 192.168.1.10    Database: rivals2
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=2700 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary table structure for view `matches_vw`
--

DROP TABLE IF EXISTS `matches_vw`;
...
/*!50001 CREATE VIEW `matches_vw` AS SELECT
 1 AS `id`,
  ...
  1 AS `ranked_placement_match`,
  1 AS `ranked_postplacement_match`,
  1 AS `notes` */;
...
CREATE TABLE `stages` (
  ...
  `ranked_singles` tinyint(4) DEFAULT 1,
  `casual_singles` tinyint(4) DEFAULT 1,
  `ranked_doubles` tinyint(4) DEFAULT 1,
  `casual_doubles` tinyint(4) DEFAULT 1,
  `aetherian` tinyint(4) DEFAULT 1,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
...
--
-- Final view structure for view `matches_vw`
--
...
-- Dump completed on 2026-03-15  8:30:43
